...
\begin{figure*}[t]
    ...
    \centering
    \caption[width=\textwidth]{The architecture of \emph{GESTALT} consists of the data collection subsystem, the ownership assignment process, the concept mapping process, and the search subsystem.\osullikomment{KLM needs to be changed to KML}}
