...
\begin{table}[h!]
	\begin{center}
		\begin{tabular}{ |c|c|c|c| } 
			...
			\hline
                DC & Hand-labeled & $0$ & $0$ \\ 
                OSM Bounding Box\tablefootnote{BoundingBox:['-77.120248', '38.791086', '-76.911012', '38.995732']} & Crowd-Sourced & $54820$\tablefootnote{$113339$ objects originally returned, $58519$ dropped for not being objects} & $165$ \\ 
			    Flickr Bounding Box & Object detection & \osullikomment{fill in when yolo finishes}$?$\tablefootnote{from $4000$ photos} & $?$  \\ 
            \hline
                OSM Bounding Box & Locations & $13223$ & $13223$\\
...
\osullikomment{0.75 for OSM and yes we sure do, they're the parent container for the objects. }
