...
Regions can be arbitrarily defined or represent an administrative boundary like a city, suburb, or general geographic area.
We select regions using bounding boxes for compatibility with the OSM and Flickr APIs.
...
Figure \ref{fig:loc} shows the winery locations in the Swan Valley Wineries dataset, and Figure \ref{fig:loc-obj} shows a detailed view of each of the six wineries that was hand labeled with ground-truth object tags.%, along with those tags and their spatial locations with respect to the winery location.
...
We assign each location or object tag ingested from OSM a confidence score of 0.75 because while any user can edit tags in the OSM database without review, the open-source community has some degree of self-regulation~\cite{VargasMunoz2020}, and prior work has examined the application of machine learning for detecting anomalous behavior in OSM edits~\cite{Mooney2017}.
...
\begin{table}[h!]
    \begin{center}
        \begin{tabular}{ |c|c|c|c|c|c| } 
            ...
            & Locations & KML file & Hand Labeled & $36$ \\%&$41$\\
...
For the Swan Valley Region we retrieve 462 images, and for the Washington DC Region, we pull 4,000 images.% out of over 12,000 available. 
