...
%however the performance of the search functionality is related to the number of objects and locations contained within the region, and so its area should be adjusted based on the density of objects and locations. 
...
\begin{figure*}[ht]       
    \includegraphics[width=0.4\textwidth]{loc_labels_plot.png}
    \centering
