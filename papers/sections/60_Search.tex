...
\nrscomment{Kent, run these queries with fuzzy search please:
query one tree without pictorial input, report time + num locs returned
query one bus stop without pictorial input, report time + num locs returned
query one bench  without pictorial input, report time + num locs returned
query one building without pictorial input, report time + num locs returned
possibly other similar ones to try to get a decent distribution of num locations so we can show the time curve. shoot for 1o locs, 100 locs, 1000 locs, 10000 locs, etc
}
