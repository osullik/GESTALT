...
\begin{figure}[h]
    ...
    \begin{subfigure}[t]{.45\textwidth} 
        ...
        \label{fig:queryExecutionRecall}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{.45\textwidth} 
        ...
        \label{fig:queryExecutionTime}
    \end{subfigure}

    \caption{Number of candidate locations and query response times for queries on the Washington D.C. Dataset (12,179 Locations, 91,188 objects).}\label{figure:PerformanceExperiments}
