...
\begin{table}[h!]
    \begin{center}
        \begin{tabular}{ |c|c|c|c|c| } 
            ...
            \hline
        \end{tabular}
        \caption{ Object-to-location assignment results for Swan Valley Wineries and Combined datasets. Increasing fuzziness parameter $c$ improves recall on the noisier \textit{Combined} dataset.} %increases the chance objects are assigned to multiple clusters, which
