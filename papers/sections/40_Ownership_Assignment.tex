...
The Swan Valley Wineries dataset consists of 31 wineries retrieved from OSM and 146 objects hand-labeled across 6 of those 31 locations with ground-truth labels. Table \ref{table:clustering} contains the recall (and precision, where applicable) on those locations and objects.
