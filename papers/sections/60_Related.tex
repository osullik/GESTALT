...
%\textit{Bellingcat} includes an interface with drop-downs and sliders...
...
%NSCH condense this down and find other OSM-based terrain search tools and summarize them here
