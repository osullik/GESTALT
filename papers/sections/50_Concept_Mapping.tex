...
The other type of spatial relationships \emph{GESTALT} supports searching are object-object relations, which are more complex than object-location relations.
...
\nrscomment{describe how object-location relationships are encoded as Concept Maps to allow for searching}

\subsubsection{Object-object encoding}
\nrscomment{describe how object-object relationships are encoded as Concept Maps to allow for searching}
