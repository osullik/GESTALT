...
class TestPoint:
    ...
    @pytest.fixture
    def setup_5_0(self):
        test_point = Point(name="testPoint", x_coord=5, y_coord=0, id=42)
        yield test_point
        del test_point

    @pytest.fixture
    def setup_5_10(self):
        test_point = Point(name="testPoint", x_coord=5, y_coord=10, id=42)
        yield test_point
        del test_point
    ...
    def test_equals(self, setup_0_0):
        assert setup_0_0 == Point(name="anotherTestPoint", x_coord=0, y_coord=0, id=13)

    def test_rotate1(self, setup_0_0):
        setup_0_0.rotate(origin=Point('C', 5, 5), angle=225)
        answer = Point("testPointPrime", 5, 5+5*math.sqrt(2))
    ...
    def test_rotate2(self, setup_5_10):
        setup_5_10.rotate(origin=Point('C', 5, 5), angle=180)
