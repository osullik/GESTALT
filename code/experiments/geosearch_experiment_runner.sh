...
#python exp_compass.py --experimentName obj10_que4 --cardinalityInvariant
python exp_compass.py --experimentName obj100_que4 --cardinalityInvariant
#python exp_compass.py --experimentName obj1000_que4 --cardinalityInvariant
...
python exp_compass.py --experimentName dist_obj10_que4 --cardinalityInvariant
python exp_compass.py --experimentName dist_obj100_que4 --cardinalityInvariant
python exp_compass.py --experimentName dist_obj1000_que4 --cardinalityInvariant
...
python exp_compass.py --experimentName obj10000_que4 --cardinalityInvariant
...
python exp_compass.py --experimentName obj10000_que10000
python exp_compass.py --experimentName dist_obj10000_que4 --cardinalityInvariant
...
#python exp_compass.py --experimentName dist_obj100000_que10000
